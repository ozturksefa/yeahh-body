    ...
    // ─────────────────────────────────────────────────
    {
      ...
      blocks: [
        ...
        { name: "🏋️ KUVVET — Push + Pull + Hinge + Squat", color: "#C1121F", exercises: [
          ...
          { name:"Chest Supported Row", sets:"4 × 10", muscle:"Mid trapez, rhomboid, posterior delt — yatay çekiş", how:["Eğik bench üstünde göğsü daya","Her iki elde DB — kollar sarkık","Kürek kemiklerini sıkıştırarak çek","1 sn tut — kontrollü in"], avoid:"Gövdeyi kaldırma — destekli çalış", warn:"BEL FITIĞI: Destekli pozisyon — spinal yük sıfır. Pull-up ile aynı günde yatay çekiş dengesi", alts:["Cable Row","Machine Row","Inverted Row"] },

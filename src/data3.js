    ...
    // ─────────────────────────────────────────────────
    {
      ...
      blocks: [
        ...
        { name: "🏋️ KUVVET — Compound Ağırlık", color: "#C1121F", exercises: [
          ...
          { name:"Barbell / DB Bent Over Row", sets:"4 × 6", muscle:"Mid trapez, rhomboid, lat, posterior delt, biceps", how:["45° öne eğik — sırt düz","Barlı/DB'yi karın/alt göğse çek","Kürek kemiklerini sıkıştır — 1 sn tut","Kontrollü indir"], avoid:"Gövdeyi kaldırma — sadece kollar çalışır", warn:"SKOLYOZ: Bilateral row — simetri kontrol et", alts:["Single Arm DB Row","Cable Row","Meadows Row"] },
          { name:"Bulgarian Split Squat", sets:"3 × 8 (her bacak)", muscle:"Quad, glute, hip flexor — unilateral bütünsel", how:["Arka ayak bench'te — ön diz hizasında","Dikey olarak in — öne değil","Ön topuk yerde kalacak","Ön ayakla it — kalça öne"], avoid:"Ön dizi ayak ucunu geçirme", warn:"DİZ: Ağrıda reverse lunge'a geç — daha az knee dominant", alts:["Reverse Lunge","Step Down","Single Leg Squat to Box"] },
        ]},
        ...
        { name: "🤸 KALİSTENİK — Push Skill", color: "#E76F51", exercises: [
          ...
          { name:"Dip", sets:"3 × max", muscle:"Triceps, alt göğüs, ön delt — pressing zinciri", how:["Kolları tam uzat — üst pozisyon","Yavaşça in — göğüs hafif öne eğik","En alta in — 90° dirsek","Patlayıcı yukarı"], avoid:"Omuzları kulağa kaldırma", warn:"Ağrıda negatife geç", alts:["Bench Dip","Dip Negative","Ring Dip"] },
        ]},
    ...
    // ─────────────────────────────────────────────────
    {
      ...
      blocks: [
        ...
        { name: "🏋️ KUVVET — Posterior Chain", color: "#F4A261", exercises: [
          ...
          { name:"Hip Thrust", sets:"4 × 10", muscle:"Glute maksimum aktivasyon", how:["Sırt bench'e","Dumbbell kalça üzerinde","Patlayıcı yukarı — 1 sn sıkıştır","Kontrollü indir"], avoid:"Beli hiperextend etme", warn:null, alts:["Banded Hip Thrust","Glute Bridge"] },
    ...
    // ─────────────────────────────────────────────────
    {
      ...
      blocks: [
        ...
        { name: "🏋️ KUVVET — Hız & Güç", color: "#8338EC", exercises: [
          { name:"Power Clean (DB / KB)", sets:"4 × 5", muscle:"Tüm posterior chain + patlayıcı güç — atletizmin özü", how:["DB'leri uyluk önünde tut","Kalçayı patlayıcı öne it — topuklara yükselt","DB'leri omuz üzerine çek — dirsekler öne","Dizleri hafif bükülü karşıla"], avoid:"Kollarla kaldırmaya çalışma — güç bacaktan gelir", warn:"Atletik güç hareketi — kontrol önce", alts:["Hang Clean","DB Hang Power Clean","KB Swing (benzer enerji sistemi)"] },
          { name:"Push Press", sets:"4 × 6", muscle:"Tüm vücut — bacak + omuz + core koordinasyon", how:["DB'leri omuz hizasında","Hafif diz bükümü — patlayıcı it","Bacak gücüyle başla — kollar tamamlar","Kontrollü indir"], avoid:"Sadece kollarla itme — bacak kullan", warn:"ROTATOR CUFF: Ağrıda landmine'a geç", alts:["Landmine Push Press","DB Shoulder Press","Thruster"] },

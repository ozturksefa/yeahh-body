  ...
  days: [
    {
      ...
      blocks: [
        { name: "🔥 ISINMA A — Postür Rutini", color: "#CC5500", exercises: [
          ...
          { name:"Deep Sumo Squat", sets:"2 × 30sn", muscle:"Kasık, iç uyluk, ayak bileği", how:["Ayaklar omuzdan geniş, parmaklar dışa","Mümkün olduğu kadar aşağı in","Topuklar yerde — kalkıyorsa altına plaka koy","Dirseklerle dizleri dışa it"], avoid:"Topukları yerden kaldırma", warn:null, alts:["Assisted Squat (MAC+)","Deep Sumo Squat (MAC+)","Frog Pose Deep Squat (MAC+)"] },
        ]},
    ...
    },
    {
      ...
      injury: "⚠️ Sağ diz menisküs — squat'ta dizi dışa aç, ağrıda derinliği azalt. Seated Leg Extension w/ Band asla atlama",
      blocks: [
        { name: "🔥 ISINMA A — Postür Rutini", color: "#CC5500", exercises: [
          ...
          { name:"Deep Sumo Squat", sets:"2 × 30sn", muscle:"Kasık, ayak bileği", how:["Geniş duruş, parmaklar dışa","Mümkün olduğu kadar aşağı in","Topuklar yerde"], avoid:"Topukları yerden kaldırma", warn:null, alts:["Assisted Squat (MAC+)","Deep Sumo Squat (MAC+)","Frog Pose"] },
        ]},
        ...
        { name: "🏋️ KUVVET", color: "#1A1A2E", exercises: [
          { name:"Dumbbell Goblet Squat", sets:"4 × 8", muscle:"Quad, glute, iç uyluk", how:["Dumbbell iki elle göğüs önünde","Dizleri dışa açarak aşağı in","Topuklar yerde","Mümkün olduğu kadar derin in"], avoid:"Dizleri içe kapatma", warn:"Sağ dizde ağrıda derinliği azalt — yarım squat yap", alts:["Box Squat","Leg Press","Band Squat (MAC+)"] },
          ...
          { name:"Dumbbell Step Up", sets:"3 × 10 (her bacak)", muscle:"Quad, glute", how:["Bench veya step — diz hizasında","Çalışan ayağı tam üzerine bas","O ayakla it — diğer bacakla itme","Tam yukarı çık, dik dur"], avoid:"Diğer ayakla sıçrama", warn:"Menisküs için squat'tan çok daha güvenli", alts:["Lateral Step Up","Box Step Down (eccentric)","Deficit Reverse Lunge"] },
        ...
        { name: "🔥 METABOLİK FİNİSHER", color: "#990000", exercises: [
          { name:"Kettlebell Swing", sets:"3 × 15", muscle:"Glute, hamstring, core — patlayıcı", how:["Kettlebell iki elle, ayaklar omuz genişliğinde","Hip hinge — squat değil","Kettlebell'i bacaklar arasından geri götür","Kalçayı patlayıcı öne it — kettlebell omuz hizasına. Set arası 45 sn."], avoid:"Kollarla kaldırmaya çalışma — güç kalçadan gelir", warn:"Sağ dizde ağrı olursa ağırlığı azalt", alts:["Dumbbell Swing","Romanian Deadlift (hızlı tempo)","Jump Squat (diz uygunsa)"] },
        ]},
        { name: "❄️ SOĞUMA", color: "#2A9D8F", exercises: [
    ...
    },
    {
      ...
      blocks: [
        { name: "🔥 ISINMA A — Postür Rutini", color: "#CC5500", exercises: [
          ...
          { name:"Deep Sumo Squat", sets:"2 × 30sn", muscle:"Kasık, ayak bileği", how:["Geniş duruş","Mümkün olduğu kadar aşağı in","Topuklar yerde"], avoid:"Topukları yerden kaldırma", warn:null, alts:["Assisted Squat (MAC+)","Deep Sumo Squat (MAC+)","Frog Pose"] },
        ]},
    ...
    },
    {
      ...
      blocks: [
        { name: "🔥 ISINMA A — Postür Rutini", color: "#CC5500", exercises: [
          ...
          { name:"Half Kneeling Hip Flexor Stretch", sets:"2 × 30sn (her taraf)", muscle:"Hip flexor", how:["Diz yerde, kalçayı öne it","Gövde dik"], avoid:"Gövdeyi öne eğme", warn:null, alts:["Half Kneeling Hip Flexor Stretch with Rotation (MAC+)","Couch Stretch","Standing Hip Flexor Stretch"] },
          { name:"Deep Sumo Squat", sets:"2 × 30sn", muscle:"Kasık, ayak bileği", how:["Geniş duruş","Topuklar yerde"], avoid:"Topukları yerden kaldırma", warn:null, alts:["Assisted Squat (MAC+)","Deep Sumo Squat (MAC+)","Frog Pose"] },
        ]},
